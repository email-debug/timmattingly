export default function Contact() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 pt-12 md:pt-16 pb-16 md:pb-24">
      <div className="mb-12 md:mb-16">
        <p className="text-sm font-medium text-stone-400 tracking-widest uppercase mb-4">Contact</p>
        <h1 className="text-3xl md:text-5xl font-light text-stone-900 mb-6">Let's talk</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
        <a href="https://calendly.com/timmattingly" className="border border-stone-200 p-6 md:p-8 hover:border-stone-900 transition-colors group">
        ...
        <a href="https://linkedin.com/in/timothywmattingly" className="border border-stone-200 p-6 md:p-8 hover:border-stone-900 transition-colors group">
